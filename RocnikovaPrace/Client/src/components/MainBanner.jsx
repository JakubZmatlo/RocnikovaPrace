...
const MainBanner = () => {
  return (
    <div className='relative'>
      <img src="" alt="banner" className='w-full hidden md:block'/>
      <img src="" alt="banner-sm" className='w-full md:hidden'/>
      ...
      <div className='flex items-center mt-6 font-medium'>
        ...
        transition rounded text-white cursor-pointer'>
            Shop now
        <img className='md:hidden transition group-focus:translate-x-1' src="" alt="white-arrow" />
        </Link>
      </div>
      </div>
    </div>
